...
import com.hdactech.rest.HallaInRestServiveApplication;
...
public class ServiceImpl implements ServiceInterface {
	...
	public Object ObjectGetInfo() throws HdacException {
		...
		mRpcCmd = (new HdacCommand(HallaInRestServiveApplication.FULL_NODE_IP, HallaInRestServiveApplication.FULL_NODE_PORT, HallaInRestServiveApplication.RPC_USER, HallaInRestServiveApplication.RPC_PW)).getChainCommand();
	...
	public Block getBlock(String blockHash) throws HdacException {
		...
		mRpcCmd = (new HdacCommand(HallaInRestServiveApplication.FULL_NODE_IP, HallaInRestServiveApplication.FULL_NODE_PORT, HallaInRestServiveApplication.RPC_USER, HallaInRestServiveApplication.RPC_PW)).getBlockCommand();
		// TODO Auto-generated method stub
	...
	public Object getTransaction(String txid, boolean includeWatchOnly) throws HdacException {
		...
		mRpcCmd = (new HdacCommand(HallaInRestServiveApplication.FULL_NODE_IP, HallaInRestServiveApplication.FULL_NODE_PORT, HallaInRestServiveApplication.RPC_USER, HallaInRestServiveApplication.RPC_PW)).getWalletTransactionCommand();
		// TODO Auto-generated method stub
	...
	public String publish(String streamName, String key, String dataHex) throws HdacException {
		...
		mRpcCmd = (new HdacCommand(HallaInRestServiveApplication.FULL_NODE_IP, HallaInRestServiveApplication.FULL_NODE_PORT, HallaInRestServiveApplication.RPC_USER, HallaInRestServiveApplication.RPC_PW)).getStreamCommand();
		// TODO Auto-generated method stub
	...
	public String grant(String address, String permission) throws HdacException {
		...
		mRpcCmd = (new HdacCommand(HallaInRestServiveApplication.FULL_NODE_IP, HallaInRestServiveApplication.FULL_NODE_PORT, HallaInRestServiveApplication.RPC_USER, HallaInRestServiveApplication.RPC_PW)).getGrantCommand();
	...
	public String signMessage(String addressORPrivateKey, String message) throws HdacException {
		...
		mRpcCmd = (new HdacCommand(HallaInRestServiveApplication.FULL_NODE_IP, HallaInRestServiveApplication.FULL_NODE_PORT, HallaInRestServiveApplication.RPC_USER, HallaInRestServiveApplication.RPC_PW)).getMessagingCommand();
		// TODO Auto-generated method stub
